...
public class Item implements Serializable {
    ...
    private Item(Long id,String name, Float price, Integer quantity) {
        this.id = id;
        this.name = name;
        this.price = price;
    ...
    public static Item from (ItemRequest itemRequest){
        return new Item(itemRequest.getId(),itemRequest.getName(),itemRequest.getPrice(),itemRequest.getQuantity());
    }
